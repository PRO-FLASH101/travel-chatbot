...
# App config
st.set_page_config(page_title="Joshua's Travel.AI",page_icon= "🌍")
st.title("Joshua's Travel.AI ✈️")

# Define the template outside the function
template = """
You are a  travel assistant chatbot your name is Joshua's Travel.AI designed to help users plan their trips and provide travel-related information. Here are some scenarios you should be able to handle:
...
if "chat_history" not in st.session_state:
    st.session_state.chat_history = [
        AIMessage(content="Hello, I am Joshua's Travel.AI How can I help you?"),
    ]
